...
import { createApplication, deleteApplication, getApplications, updateApplication } from 'services/RestApi';
...
export default function SetupApplication() {
    ...
    useEffect(()=>{
        setPageData({...pageData, active:'master-data', title: 'Application Source' })
        fetchData();
    },[])
    ...
    async function fetchData() {
        try {
            ...
            let _response = await getApplications();
            setApplicationData(_response.data)
            toast.dismiss()
        } catch(error) {
            toast.dismiss()
